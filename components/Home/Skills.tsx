...
const Skills = () => {
  ...
  return (
    <div id="skills" className="flex flex-col w-full items-center justify-center py-11 px-8 lg:px-48">
        <div className="flex flex-col lg:ml-20 w-full">
                    ...
                    <SplideTrack>
                        <SplideSlide>
                            <div className="flex flex-col w-full px-6 py-5 bg-skin-fill-secondary rounded-2xl justify-start mb-10 h-80">
                                ...
                                {software.map((skill: skillsType, index: number) => <p className='pt-2 font-patron font-normal text-md' key={index}><b>{skill.heading}: </b>{skill.prompt}</p>)}
                            </div>
                        </SplideSlide>
                        <SplideSlide>
                            <div className="flex flex-col w-full px-6 py-5 bg-skin-fill-secondary rounded-2xl justify-start mb-10 h-80">
                                <h3 className='font-patron font-bold text-lg mb-5 mt-2'>Cloud & DevOps</h3>
                                {cloudNDevops.map((skill: skillsType, index: number) => <p className='pt-2 font-patron font-normal text-md' key={index}><b>{skill.heading}: </b>{skill.prompt}</p>)}
                            </div>
                        </SplideSlide>
                    </SplideTrack>
                </Splide>
            ...
            <div className="hidden lg:flex w-full items-center justify-center gap-6 mt-10">
                <div className="flex flex-col w-full p-10 justify-center bg-skin-fill-secondary rounded-2xl mb-10 h-80">
                    ...
                    {software.map((skill: skillsType, index: number) => <p className='pt-2 font-patron font-normal text-xl' key={index}><b>{skill.heading}: </b>{skill.prompt}</p>)}
                </div>
                <div className="flex flex-col w-full p-10 justify-center bg-skin-fill-secondary rounded-2xl mb-10 h-80">
                    <h3 className='font-patron font-bold text-2xl mb-5 mt-2'>Cloud & DevOps</h3>
                    {cloudNDevops.map((skill: skillsType, index: number) => <p className='pt-2 font-patron font-normal text-xl' key={index}><b>{skill.heading}: </b>{skill.prompt}</p>)}
                </div>
            </div>
        </div>
    </div>
